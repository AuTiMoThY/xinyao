...
<?= $this->include("frontend/include/searchbar") ?>
    ...
    <div class="page_main-container">
        ...
        <div class="cart__wrap">
            ...
            <div class="cart-ft">
                <button @click="addToFav" type="button" class="xinyao_btn xinyao_btn-nobg" :disabled="isDisabled" v-if="showAddFavBtn">加入常用</button>
...
<script type="module" src="<?= js_url('frontend/cart2.js?v=' . WEB_VERSION) ?>"></script>
<?= $this->endSection() ?>